...
ENV_LAMBU_CACHE_DIR = "LAMBU_CACHE_DIR"

_CACHE_DIR = os.environ.get(ENV_LAMBU_CACHE_DIR, f"{tempfile.gettempdir()}/lambu_cache/")
...
# Remove all whitespaces and created an ordered list of entries
# Hash list
